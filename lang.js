...
const i18n = {
  tr: {
    ...
    'svc.katalog.h3':    'E-Katalog Sistemleri',
    'svc.katalog.p':     'Fiziksel broşürleri veya hantal PDF\'leri dijitale taşıyoruz. Yüksek performanslı, çok dilli ve modern kataloglar hazırlıyoruz.',
    'svc.katalog.li1':   'Anında açılan sayfalar (Sıfır yükleme süresi)',
    'svc.katalog.li2':   'Çift dil desteği (TR/EN)',
    // Projects
    'proj.tag':           'Projeler',
    ...
    'proj.sedirkon.type':    'Kurumsal E-Katalog',
    'proj.sedirkon.sub':     'Dijital Katalog Sistemi',
    'proj.sedirkon.impact':  'Müşterilerin PDF bekleme süresini sıfıra indirdik. <strong>Yüksek performanslı</strong> bir vitrin oluşturduk.',
    'proj.sedirkon.h3':      'Sedirkon Mobilya — Dijital Katalog',
    'proj.sedirkon.p':       'Sedirkon firması için tasarlanmış, ağır PDF dosyalarının yerini alan; yüksek çözünürlüklü 3D render görselleriyle donatılmış, çift dilli (TR/EN) dijital mobilya kataloğu.',
    'proj.sedirkon.li1':     '12 sayfalık dinamik sayfalama',
    'proj.sedirkon.li2':     'Kusursuz çift dil (TR/EN) desteği',
    'proj.sedirkon.li3':     'Masaüstü (Desktop Only) Deneyim',
    // Contact
  ...
  en: {
    ...
    'svc.katalog.h3':    'E-Catalog Systems',
    'svc.katalog.p':     'We digitize physical brochures and bulky PDFs. We build high-performance, multilingual, and modern catalogs.',
    'svc.katalog.li1':   'Instant page loads (Zero wait time)',
    'svc.katalog.li2':   'Dual language support (TR/EN)',
    // Projects
    'proj.tag':           'Projects',
    ...
    'proj.sedirkon.type':    'Enterprise E-Catalog',
    'proj.sedirkon.sub':     'Digital Catalog System',
    'proj.sedirkon.impact':  'We reduced PDF wait times to zero. Created a <strong>high-performance</strong> showcase.',
    'proj.sedirkon.h3':      'Sedirkon Furniture — Digital Catalog',
    'proj.sedirkon.p':       'A bilingual (TR/EN) digital furniture catalog with high-res 3D renders, designed for Sedirkon to replace heavy PDF files.',
    'proj.sedirkon.li1':     '12-page dynamic layout',
    'proj.sedirkon.li2':     'Flawless dual language (TR/EN) support',
    'proj.sedirkon.li3':     'Desktop Only experience',
    // Contact
    'contact.tag':        'Contact',
